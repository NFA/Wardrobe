...
#line 1 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
#include <iostream>
#include <cstring>
#include <memory>
#include <iomanip>
...
#line 88 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
...
#line 49 "/Users/NFA/development/ragel_test/derived/lexer.cpp"
	{
	cs = lexer_start;
	ts = 0;
	te = 0;
...
#line 107 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"

}

void Lexer::Execute() { 
  
#line 63 "/Users/NFA/development/ragel_test/derived/lexer.cpp"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
	{
tr0:
#line 62 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  //++line_col;
}}
	goto st1;
tr2:
#line 49 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  addToken(TokenType::OpenP, getTokenData(ts, te));
}}
	goto st1;
tr3:
#line 53 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  addToken(TokenType::CloseP, getTokenData(ts, te));
}}
	goto st1;
tr4:
#line 41 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
    addToken(TokenType::Times, getTokenData(ts, te));
}}
	goto st1;
tr5:
#line 33 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  addToken(TokenType::Plus, getTokenData(ts, te));
}}
	goto st1;
tr6:
#line 37 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  addToken(TokenType::Minus, getTokenData(ts, te));
}}
	goto st1;
tr7:
#line 45 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  addToken(TokenType::Divide, getTokenData(ts, te));
}}
	goto st1;
tr9:
#line 29 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p+1;{
  addToken(TokenType::Semi, getTokenData(ts, te));
}}
	goto st1;
tr10:
#line 57 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
	{te = p;p--;{
...
#line 1 "NONE"
	{ts = p;}
#line 132 "/Users/NFA/development/ragel_test/derived/lexer.cpp"
	switch( (*p) ) {
		case 32: goto tr0;
		case 40: goto tr2;
		case 41: goto tr3;
...
#line 112 "/Users/NFA/development/ragel_test/ragel_test/lexer.rl"
}
